 ...
 */
final class Version20250911102018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE kilometre_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE agent (id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, service VARCHAR(255) NOT NULL, lien_empl VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE bailleur (id INT NOT NULL, mission_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, taux_ag DOUBLE PRECISION NOT NULL, taux_ox DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7ABB27F3BE6CAE90 ON bailleur (mission_id)');
        $this->addSql('CREATE TABLE carburant (id INT NOT NULL, mission_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, quantite DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE evenement (id INT NOT NULL, vehicule_id INT DEFAULT NULL, chauffeur_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, debut DATE NOT NULL, fin DATE NOT NULL, description VARCHAR(255) NOT NULL, background_color VARCHAR(255) NOT NULL, border_color VARCHAR(255) NOT NULL, text_color VARCHAR(255) NOT NULL, dotation VARCHAR(60) DEFAULT NULL, montant DOUBLE PRECISION DEFAULT NULL, destination VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE kilometre (id INT NOT NULL, nom VARCHAR(255) NOT NULL, kilometre DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE bailleur ADD CONSTRAINT FK_7ABB27F3BE6CAE90 FOREIGN KEY (mission_id) REFERENCES evenement (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE kilometre_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE bailleur DROP CONSTRAINT FK_7ABB27F3BE6CAE90');
        ...
        $this->addSql('DROP TABLE kilometre');
